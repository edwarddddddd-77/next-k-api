...
TOUCH_POOL_MIN_TOTAL_TRADES: int = 5
TOUCH_POOL_MIN_WIN_LOSS_ABS: int = 3
TOUCH_POOL_MIN_TOUCH_TRADES: int = 3  # 与 MIN_WIN_LOSS_ABS 对齐
TOUCH_POOL_MIN_TOUCH_WIN_RATE: float = 0.70
