...
MOSS_QUANT_OPTIMIZE_TUNING_DIAG_ENABLED = True
MOSS_QUANT_OPTIMIZE_LOCAL_REFINE_ENABLED = True
MOSS_QUANT_OPTIMIZE_LOCAL_REFINE_MAX_ROUNDS = 3

# --- L3：最近 1500 根定模板+战术（与纸面 K 线同长）---
MOSS_QUANT_RECENT_PICK_ENABLED = True
...
MOSS_QUANT_RECENT_PICK_MAX_COMBINATIONS = 36
