...
class TouchPoolFilterTests(unittest.TestCase):
    ...
    def test_filter_rejects_win_loss_below_10(self) -> None:
        summary = {
            "per_symbol": {
                "XUSDT": {
                    "win": 5,
    ...
    def test_filter_rejects_win_loss_above_max(self) -> None:
        summary = {
            "per_symbol": {
                "XUSDT": {
                    "win": 30,
