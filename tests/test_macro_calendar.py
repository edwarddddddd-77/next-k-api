...
from quant.common.macro_calendar import (
...
class TestMacroCalendar(unittest.TestCase):
    ...
    @patch("quant.common.macro_calendar.requests.get")
    ...
    @patch("quant.common.macro_calendar.fetch_cpi_skip_dates", return_value=({"2099-01-01"}, True))
    @patch("quant.common.macro_calendar.fetch_fomc_skip_dates", return_value=({"2099-02-02"}, True))
    ...
    @patch("quant.common.macro_calendar.fetch_cpi_skip_dates", return_value=(set(), False))
    @patch("quant.common.macro_calendar.fetch_fomc_skip_dates", return_value=(set(), False))
    ...
    def test_macro_skip_logs_once(self):
        ...
        with self.assertLogs("quant.common.macro_calendar", level="INFO") as cm:
            self.assertTrue(is_macro_skip_day("2026-05-12"))
            self.assertTrue(is_macro_skip_day("2026-05-12"))
    ...
    def test_macro_calendar_status_fields(self):
        os.environ["ORB_MACRO_CALENDAR_FETCH"] = "0"
        from quant.common.macro_calendar import macro_calendar_status
